...
{
    private static IRuntimeContext fContext;
    ...
    public static void SetContext(IRuntimeContext context)
    {
        if (context != null) {
            fContext = context;
        }
    ...
    public static void RegisterTool(BaseTool tool, bool metaTool = false)
    {
