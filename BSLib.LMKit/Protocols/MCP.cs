...
namespace BSLib.LMKit.Protocols;
...
public class MCPContent
{
    ...
    public static Task<List<MCPContent>> CreateSimpleContentAsync(string text)
    {
        return Task.FromResult(new List<MCPContent> { new MCPContent { Text = text } });
    }
