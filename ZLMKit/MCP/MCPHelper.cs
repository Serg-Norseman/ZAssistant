...
public static class MCPHelper
{
    ...
    public static JsonElement GetRequiredObj(JsonElement args, string argName)
    {
    ...
    public static string[] GetRequiredStringArray(JsonElement args, string argName)
    {
        if (!args.TryGetProperty(argName, out var argElem) || argElem.ValueKind != JsonValueKind.Array)
            throw new ArgumentException($"Missing required argument: {argName}");
    ...
    public static string[] GetOptionalStringArray(JsonElement args, string argName, string[] defaultValue)
    {
        if (!args.TryGetProperty(argName, out var argElem) || argElem.ValueKind != JsonValueKind.Array)
            return defaultValue;
    ...
    public static bool GetRequiredBool(JsonElement args, string argName)
    {
