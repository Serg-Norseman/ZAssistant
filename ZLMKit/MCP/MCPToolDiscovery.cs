...
{
    void AdjustQueryLimit(ref string[] queryTokens, ref int limit);
}
...
public static class MCPToolDiscovery
{
    ...
    private static IQueryEqualizer fQueryEqualizer;


    public static void SetQueryEqualizer(IQueryEqualizer queryEqualizer)
    {
        fQueryEqualizer = queryEqualizer;
    }
    ...
    public static IEnumerable<MCPTool> Search(string query, int limit = 5)
    {
        ...
        fQueryEqualizer?.AdjustQueryLimit(ref queryTokens, ref limit);
